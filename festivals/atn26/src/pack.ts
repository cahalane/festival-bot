/**
 * atn26 declarative pack (festival.json, venues.json, knowledge/*.md), loaded via
 * the shared `createPack` factory. The full FestivalModule is assembled in ./index.ts.
 */
...
export const SCHEDULE_FILE = pack.scheduleFile;
