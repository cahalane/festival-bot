> ⚠️ **CARRIED OVER FROM 2026 — NOT VERIFIED FOR 2027.** Kept because the underlying site
> (Parc del Fòrum) is stable year to year, so this is a sound starting point rather than a
> blank page. Sponsor-named stages, vendors and layout details WILL have changed. Re-verify
> against the announced 2027 site map before anyone plans a route from it.
